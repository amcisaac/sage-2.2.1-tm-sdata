...
python curate-dataset.py download-opt                                           \
    ...
    --iodine-opt-dataset    "OpenFF multiplicity correction optimization set v1.0" \
    --iodine-opt-dataset    "OpenFF Torsion Multiplicity Optimization Training Coverage Supplement v1.0" \
